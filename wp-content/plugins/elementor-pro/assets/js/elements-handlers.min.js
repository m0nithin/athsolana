            ...
            class BaseFilterFrontendModule extends elementorModules.Module {
                ...
                refreshLoopWidget(e, t) {
                    ...
                    return this.fetchUpdatedLoopWidgetMarkup(e, t).then((e => e instanceof Response && e ? .ok && !(400 <= e ? .status) ? e.json() : {})).catch((e => ({}))).then((t => {
                        ...
                        n.replaceChild(o, s), this.handleElementHandlers(o), elementorFrontend.elementsHandler.runReadyTrigger(document.querySelector(`.elementor-element-${e}`)), n.classList.remove("e-loading")
                    })).finally((() => {
